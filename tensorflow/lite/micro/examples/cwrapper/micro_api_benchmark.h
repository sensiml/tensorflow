...
static int test_invoke(char *tflite_buffer, size_t arena_size, float* input_data, int num_inputs, float* results,
                           int num_outputs)) {
...
static int find_arena_size(char *tflite_buffer, int * arena_size, size_t a_low, size_t a_high) {
